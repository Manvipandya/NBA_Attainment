    					 ...
    					 String subject = (String)session.getAttribute("subject");
          				...
          				int subject1 = Integer.parseInt(subject);
                                try{
                                    ...
                                    String query = "Select * from copso where course_id = '"+subject1+"'";
                   ...
                   %>
							    ...
							    <div class="row" >
							      ...
							      for(j=1;j<=3;j++)
							      {
							      	...
							      	<div class="col-lg-4" ><input type="text" name="<%=i%><%=j%>"  placeholder=<%=rs.getInt("mapping")%> disabled style="background-color:white;text-align:center;color:black;border:none;"></div>
							      	
							      	<% }
							    	  else
							    	  {%>
							    		  <div class="col-lg-4" ><input type="text" name="<%=i%><%=j%>"  placeholder="-" disabled style="background-color:white;text-align:center;color:black;border:none;"></div>
							    	 <%  }
